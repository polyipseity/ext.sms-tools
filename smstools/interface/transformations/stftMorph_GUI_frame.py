...
from smstools.interface.transformations import stftMorph_function as sT
...
class StftMorph_frame:
    ...
    def initUI(self):
        ...
        self.transf_output = Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation1.get())[:-4] + '_stftMorph.wav'))
