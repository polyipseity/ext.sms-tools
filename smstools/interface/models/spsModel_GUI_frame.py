# GUI frame for the spsModel_function.py

from tkinter import *
import sys, os
from tkinter import filedialog, messagebox

from smstools.interface.models import spsModel_function
...
class SpsModel_frame:
    ...
    def initUI(self):
        ...
        Label(self.parent, text=stocf_label).grid(row=10, column=0, sticky=W, padx=5, pady=(10,2))
        ...
        self.output = Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_spsModel_sines.wav'))
        ...
        self.output = Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_spsModel_stochastic.wav'))
        ...
        self.output = Button(self.parent, text=">", command=lambda:UF.wavplay('output_sounds/' + os.path.basename(self.filelocation.get())[:-4] + '_spsModel.wav'))
