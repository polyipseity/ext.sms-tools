...
def submit():   
    print ('==\n== Submitting Solutions: Programming Assignment-4\n==')
...
ASSIGNMENT_KEY = 'nWnw81jwEea43A5qnbInTQ'

# DEFINE THE PartIds in this list for each PA
LIST_PARTIDS = ['IEoqE', '2QHWa', 'fvkt7'] ################## CHANGE THE PART IDS HERE !!
...
def output(partIdx):
    ...
    outputString = ''
    filename = open('testInputA4.pkl','rb')
